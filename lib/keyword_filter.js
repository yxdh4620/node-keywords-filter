...
(function() {
  var NodeTree, change_case, position, replaceIndexChar, rollback, rootNode, subNode, tempNode;
  ...
  module.exports = {
    ...
    replaceKeyword: function(str, reChar) {
      var i, _i, _ref, _ref1;
      if (reChar == null) {
        reChar = '*';
      }
    ...
    replaceStrKeyword: function(str, reStr) {
      if (reStr == null) {
        reStr = '敏感词';
      }
      tempNode = rootNode;
