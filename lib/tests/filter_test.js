...
(function() {
  var array, keyword_filter, should, str1, str2, str3, str4, strs;
  ...
  describe("test keyword_filter", function() {
    before(function() {});
    return describe("checksum", function() {
      ...
      it("keyword_filter replaceKeyword", function(done) {
        strs.map(function(str) {
          console.log(str);
          return console.log(keyword_filter.replaceKeyword(str));
        });
        return done();
      });
      return it("keyword_filter replaceIndexChar", function(done) {
        strs.map(function(str) {
          console.log(str);
          return console.log(keyword_filter.replaceStrKeyword(str));
        });
        return done();
      });
    });
